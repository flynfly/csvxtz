...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.doubleSpinBox.setGeometry(QtCore.QRect(10, 760, 62, 22))
        self.doubleSpinBox.setObjectName("doubleSpinBox")
        self.horizontalSlider_2 = QtWidgets.QSlider(self.centralwidget)
        self.horizontalSlider_2.setGeometry(QtCore.QRect(420, 780, 721, 22))
        self.horizontalSlider_2.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_2.setTickPosition(QtWidgets.QSlider.TicksAbove)
        self.horizontalSlider_2.setObjectName("horizontalSlider_2")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(380, 740, 31, 31))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(380, 780, 31, 21))
        self.label_3.setObjectName("label_3")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(290, 760, 81, 31))
        self.pushButton.setObjectName("pushButton")
        self.checkBox = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox.setGeometry(QtCore.QRect(230, 80, 71, 16))
        self.checkBox.setObjectName("checkBox")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(230, 30, 54, 12))
        self.label_4.setObjectName("label_4")
        self.checkBox_2 = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_2.setGeometry(QtCore.QRect(230, 660, 71, 16))
        ...
        self.pushButton.clicked.connect(mainWindow.lower)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.checkBox.setText(_translate("mainWindow", "通道"))
        self.label_4.setText(_translate("mainWindow", "通道："))
        self.checkBox_2.setText(_translate("mainWindow", "通道"))
